...
for(const name of ['style.css','voyage.css','fonts.css']){
...
for(const name of ['dist/app.js','dist/world.js','dist/village-layout.js','dist/village-life.js','dist/prop-assets.js','dist/troop-assets.js','server.mjs'])execFileSync(process.execPath,['--check',path.join(root,name)],{stdio:'pipe'});
