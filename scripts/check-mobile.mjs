...
for(const [width,height] of [[320,568],[360,800],[390,844],[430,932],[768,1024],[844,390],[932,430],[1024,768]]){
 for(const dpr of [1,2,3,4]){
  ...
  assert.ok(width*height*budget.pixelRatio**2<=850001);assert.equal(budget.fps,24);
